    ...
    <div class="container w-full mx-auto pt-20">
        ...
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
            ...
            <div class="w-full pt-3 block items-center justify-center xl:flex lg:flex">
                <div class="">
                    <p class="text-4xl">Evaluasi Keluhan Pasien</p>
                </div>
                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Keluhan User</th>
                                <th class="py-3 px-6 text-left">Terapi</th>
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <a href="/evaluasi-user/view/{{ $data->id }}"
