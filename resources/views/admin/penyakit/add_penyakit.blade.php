    ...
    <div class="container w-full mx-auto pt-20">
        <div class="w-full px-4 md:px-0 md:mt-8 text-gray-800 leading-normal">
            ...
            <div class="w-full pt-3 flex items-center">
                <div class="">
                    <p class="text-4xl">Tambah Data Penyakit</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
                        ...
                        <div class="flex justify-center">
                            <div class="m-7 max-w-md">
                                <form action="/penyakit/add/proses" method="POST" id="form">
                                    @csrf

                                    <div class="mb-6">
                                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Full
                                            Nama Penyakit</label>
                                        <input type="text" name="nama_penyakit" id="name" placeholder="cth: Nyeri Kronis"
                                            required
                                    ...
                                    <div class="mb-6">
                                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Full
                                            Kode Penyakit</label>
                                        <input type="text" name="kode_penyakit" id="name" placeholder="cth: (D.0078)"
                                            required
                                            class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300" />
                                    </div>
